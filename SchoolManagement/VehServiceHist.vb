...
Public Class VehServiceHist
    ...
    Private Sub LoadVSHistory()
        Access.ExecQuery("SELECT ServiceID AS [Service ID], ServiceName AS [Service Name], ServiceType AS [Service Type], Vehicle,
                            Details, ServiceDate AS [Date], ServiceCost AS Cost
    ...
    Private Sub VehServiceHist_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Me.Text = Form1.User & " - Vehicle Service History"
        LoadVSHistory()
    End Sub
