...
Public Class InternalFunctions
    ...
    Public Sub LoadFunctions()
        Access.ExecQuery(" SELECT [ID], FunctionName AS [Name], FunctionType As [Type of Function], FunctionDate AS [Date],
                            FunctionTime AS [Time of Function], FunctionDetails AS Details
    ...
    Private Sub InternalFunctions_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Me.Text = Form1.User & " - Internal Functions"
        LoadFunctions()
    End Sub
    ...
    Private Sub SaveFunctions()
        ...
        Access.ExecQuery("INSERT INTO InternalFunctions (FunctionName, FunctionType, FunctionDate, FunctionTime, FunctionDetails) " &
                         "VALUES (@fname, @ftype, @fdate, @ftime, @dets); ")
        If Not String.IsNullOrEmpty(Access.Exception) Then
            MsgBox(Access.Exception)
        End If
        MsgBox("New Internal Event Saved Successfully!", MsgBoxStyle.Information, "Success!")
        LoadFunctions()
    End Sub
